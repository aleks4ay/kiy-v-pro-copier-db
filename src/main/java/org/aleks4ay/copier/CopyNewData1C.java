...
import org.aleks4ay.copier.dao.*;
import org.aleks4ay.copier.dbf.*;
import org.aleks4ay.copier.service.*;
import org.aleks4ay.copier.tools.Constants;
import org.aleks4ay.copier.tools.DataControl;
...
public class CopyNewData1C {
    ...
    public static void main(String[] args) {
        ...
        while (true) {
            ...
            try {
                for (int i = 0; i < 600; i++) {
                    Thread.sleep(1000); // sleep 600 timed by 1 sec = 10 min
                    switch (i % 4) {
                    case 0:
                        System.out.print("\r/");
                        break;
